    ...
    <section class="hero" id="events">
      <div class="hero-grid">
        <div class="hero-copy">
          ...
          <div class="hero-social" aria-label="Social links" data-reveal>
            <a class="hero-social-link" href="https://www.instagram.com/uwindsor.ai.club/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.8 2h8.4A5.8 5.8 0 0 1 22 7.8v8.4A5.8 5.8 0 0 1 16.2 22H7.8A5.8 5.8 0 0 1 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2Zm0 2A3.8 3.8 0 0 0 4 7.8v8.4A3.8 3.8 0 0 0 7.8 20h8.4a3.8 3.8 0 0 0 3.8-3.8V7.8A3.8 3.8 0 0 0 16.2 4H7.8Zm4.2 4a6 6 0 1 1 0 12 6 6 0 0 1 0-12Zm0 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm6.4-.9a1.1 1.1 0 1 1-2.2 0 1.1 1.1 0 0 1 2.2 0Z"/></svg>
              <span>Instagram</span>
            </a>
            <a class="hero-social-link" href="https://www.linkedin.com/company/uwindsor-ai-club" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.11 1 2.48 1 4.98 2.12 4.98 3.5zM0.2 8.2H4.8V24H0.2V8.2zM8.2 8.2h4.4v2.2h.1c.6-1.1 2.1-2.3 4.4-2.3 4.7 0 5.6 3.1 5.6 7.1V24h-4.6v-7.7c0-1.8 0-4.2-2.6-4.2-2.6 0-3 2-3 4.1V24H8.2V8.2z"/></svg>
              <span>LinkedIn</span>
            </a>
            <a class="hero-social-link" href="https://discord.gg/mGmrU7Gr6N" target="_blank" rel="noopener noreferrer" aria-label="Discord">
              <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.3 4.6A16.5 16.5 0 0 0 16.2 3l-.2.4a15 15 0 0 1 3 1.5 11.6 11.6 0 0 0-4.4-1.3 10.6 10.6 0 0 0-1 .2 12.7 12.7 0 0 0-3.2 0 10.6 10.6 0 0 0-1-.2A11.6 11.6 0 0 0 5 4.9a15 15 0 0 1 3-1.5L7.8 3A16.5 16.5 0 0 0 3.7 4.6C1.6 7.8.9 10.9 1.1 14a16.6 16.6 0 0 0 5 2.6l.7-1.1a10.4 10.4 0 0 1-1.6-.8l.4-.3a11.7 11.7 0 0 0 9.8 0l.4.3a10.4 10.4 0 0 1-1.6.8l.7 1.1a16.6 16.6 0 0 0 5-2.6c.3-3.1-.5-6.2-2.6-9.4ZM8.5 12.9c-.7 0-1.3-.7-1.3-1.5S7.8 9.9 8.5 9.9s1.3.7 1.3 1.5-.6 1.5-1.3 1.5Zm7 0c-.7 0-1.3-.7-1.3-1.5s.6-1.5 1.3-1.5 1.3.7 1.3 1.5-.6 1.5-1.3 1.5Z"/></svg>
              <span>Discord</span>
            </a>
          </div>
        </div>
