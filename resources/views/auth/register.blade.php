...
@section('title', 'Register | Windsor AI Club')
...
@section('content')
    <div class="events-hero">
        ...
        <div class="events-hero-content" data-reveal>
            ...
            <h1 data-reveal>Create account</h1>
            <p class="events-season" data-reveal>Join the member portal</p>
            <p class="sub" data-reveal>Register to access your dashboard (and admin tools if enabled).</p>
        </div>
    </div>
        ...
        <div class="auth-card" data-reveal>
            <form class="auth-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="auth-actions">
                    <button class="btn primary breath" type="submit">{{ __('Register') }}</button>
                    <a class="btn secondary" href="{{ route('login') }}">{{ __('Already registered') }}</a>
                </div>
            </form>
        </div>
    </div>
